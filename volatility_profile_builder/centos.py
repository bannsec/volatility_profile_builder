...
import logging
logger = logging.getLogger("volatility_profile_builder:CentOS")
...
def build_profile(tag):
    ...
    img_tag = "volatility_profile_builder:centos-{}".format(tag)

    # Create Dockerfile
    with open(os.path.join(here,"docker","Dockerfile_centos"), "r") as f:
        dockerfile = f.read()
    ...
    with tempfile.TemporaryDirectory() as tmpdirname:
        ...
        print("Building image for centos:" + tag + " ... ", end='', flush=True)
